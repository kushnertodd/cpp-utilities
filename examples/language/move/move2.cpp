...
int main() {
  ...
  A a1(1);
  std::cout << "  illegal: A& a2(2);" << std::endl;
  ...
  A& a5(a4);
  std::swap(a5, a5);
  std::cout << "  illegal: A&& a6(a5);" << std::endl;

  std::cout << "  A a6(A(6));" << std::endl;
  A a6(A(6));
  std::cout << "  illegal: A& a7(A(7));" << std::endl;
  ...
  std::cout << "  illegal: A& a7z(rval_to_rval(a6z));" << std::endl;
  ...
  A a13x = a13;
  std::swap(a13x, a13x);
  std::cout << "  illegal: A&& a14(a13);" << std::endl;

  std::cout << "  const A a15(A(15));" << std::endl;
  const A a15(A(15));
  std::cout << "  illegal: A& a16(A(16));" << std::endl;
  ...
  std::swap(a23, a23);
  std::cout << "  illegal: A& a24 = rval_to_rval(A(24));" << std::endl;
  ...
  std::cout << "  illegal: A& a27 = ref_to_rval(a26);" << std::endl;
  ...
  std::swap(a29, a29);
  std::cout << "  illegal: A& a30 = rval_ref_to_rval(A(30));" << std::endl;
  ...
  // std::swap(a32, a32);
  std::cout << "  illegal: A& a33 = rval_to_rval_ref(A(33));" << std::endl;
  ...
  std::cout << "  illegal: A& a36 = ref_to_rval_ref(a35);" << std::endl;
  ...
  std::swap(a38, a38);
  std::cout << "  illegal: A& a39 = rval_ref_to_rval_ref(A(39));" << std::endl;
