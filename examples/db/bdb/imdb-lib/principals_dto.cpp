...
const std::string Principals_DTO::class_name = "Principals_DTO";
...
size_t Principals_DTO::buffer_size() const {
  size_t len = 0;
  len += Serialization::buffer_len_string(id);
  len += Serialization::buffer_len_string(title_id);
  len += Serialization::buffer_len_string(name_id);
  len += Serialization::buffer_len_string(category);
  len += Serialization::buffer_len_string(job);
  len += Serialization::buffer_len_string(characters);
  return len;
}

void *Principals_DTO::deserialize(void *buffer) {
  auto *p = (unsigned char *) buffer;
  p = (unsigned char *) Serialization::deserialize_string(id, p);
  p = (unsigned char *) Serialization::deserialize_string(title_id, p);
  p = (unsigned char *) Serialization::deserialize_string(name_id, p);
  p = (unsigned char *) Serialization::deserialize_string(category, p);
  p = (unsigned char *) Serialization::deserialize_string(job, p);
  p = (unsigned char *) Serialization::deserialize_string(characters, p);
  return p;
}

bool Principals_DTO::equals(const Principals_DTO &principals_DTO) const {
  return (id == principals_DTO.id
      && title_id == principals_DTO.title_id
      && name_id == principals_DTO.name_id
      && category == principals_DTO.category
      && job == principals_DTO.job
      && characters == principals_DTO.characters);
}
...
void *Principals_DTO::serialize(void *buffer) const {
  auto *p = (unsigned char *) buffer;
  p = (unsigned char *) Serialization::serialize_string(id, p);
  p = (unsigned char *) Serialization::serialize_string(title_id, p);
  p = (unsigned char *) Serialization::serialize_string(name_id, p);
  p = (unsigned char *) Serialization::serialize_string(category, p);
  p = (unsigned char *) Serialization::serialize_string(job, p);
  p = (unsigned char *) Serialization::serialize_string(characters, p);
  return p;
}
...
const std::string Principals_DTO_list::class_name = "Principals_DTO_list";
